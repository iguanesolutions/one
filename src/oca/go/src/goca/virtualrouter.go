...
func (vc *VirtualRoutersController) Create(name string, tpl *DynamicTemplate) (int, error) {
	if tpl == nil {
...
func (vc *VirtualRouterController) Instantiate(number, tplid int, name string, hold bool, extraTpl *VMTemplate) (int, error) {
	extraTplStr := ""
	if extraTpl != nil {
